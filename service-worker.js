const CACHE='debt-diff-app-v2-redesign-20260524';
const FILES=['./','./index.html','./style.css?v=20260524-redesign2','./app.js?v=20260524-redesign2','./manifest.json','./icon.svg'];
